...
void 	init_scene(t_render *render)
{
	...
	render->object[4] = obj(PLANE, 1e5, 0,										// BACK
						...
						vecp(0.0, 0.0, 0.0),
					 	DIFFUSE);
	render->object[5] = obj(SPHERE, 8.0, 0,										// LIGHT BACK LEFT
						vecp(100.0 - 15.0, 0.0 + 15.0, 0.0 + 15.0),
						vecp(0.0, 1.0, 0.0),
						vecp(15.0, 15.0, 15.0),
						vecp(0.0, 0.0, 0.0),
					 	DIFFUSE);
	render->object[6] = obj(SPHERE, 8.0, 0.0,									// LIGHT BACK RIGHT
						vecp(0.0 + 15.0, 0.0 + 15.0, 0.0 + 15.0),
						vecp(0.0, 0.0, 0.0),
						vecp(12.0, 12.0, 12.0),
						vecp(0.0, 0.0, 0.0),
						DIFFUSE);
	render->object[7] = obj(SPHERE, 8.0, 0,										// LIGHT FRONT LEFT
						vecp(100.0 - 15.0, 0.0 + 15.0, 100.0 + 15.0),
						vecp(0.0, 1.0, 0.0),
						vecp(15.0, 15.0, 15.0),
						vecp(0.0, 0.0, 0.0),
					 	DIFFUSE);
	render->object[8] = obj(SPHERE, 8.0, 0.0,									// LIGHT FRONT RIGHT
						vecp(0.0 + 15.0, 0.0 + 15.0, 100.0 + 15.0),
						vecp(0.0, 0.0, 0.0),
						vecp(12.0, 12.0, 12.0),
						vecp(0.0, 0.0, 0.0),
						DIFFUSE);
	...
	// 					vecp(25.0, 25.0, 80.0),
	// 					DIFFUSE);
	render->object[9] = obj(SPHERE, 16.5, 0,									// SPHERE
						vecp(73.0, 16.5, 78.0),
						vecp(0.0, 0.0, 0.0),
						vecp(0.0, 0.0, 0.0),
						vecp(0.0, 0.0, 0.0),
						DIFFUSE);
	render->object[10] = obj(SPHERE, 16.5, 0,									// SPHERE SPEC
						vecp(30.0, 16.5, 78.0),
						vecp(0.0, 0.0, 0.0),
						vecp(0.0, 0.0, 0.0),
						vecp(0.0, 0.0, 0.0),

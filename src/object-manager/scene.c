...
void 	init_scene(t_rtv1 *rtv1, char *file)
{
	...
	scene->obj_options = ft_strsplit("POSITION DIRECTION EMISSION COLOR REFLECTION RADIUS ANGLE HEIGHT WIDTH DEPTH FOV AMBIENT ROTATION TEXTURE INDEX", ' ');
...
options_func *setup_obj_setter(void)
{
	...
	obj_setter = (options_func*)ft_memalloc(sizeof(options_func) * 15);

...
/*   Updated: 2020/01/23 16:58:17 by mcabrol          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void 	init_scene(char **av, t_rtv1 *rtv1)
{
	...
	// 				vecp(0.75, 0.75, 0.25),
	// 				DIFF); // obj diff
	rtv1->scene.obj[1] = obj(SPHERE, 10.00,
					vecp(130.0, 16.5, 80.0),
					vecp(12.0, 12.0, 12.0),
					vecp(0.75, 0.55, 0.15),
					DIFF); // obj diff
	rtv1->scene.obj[2] = obj(SPHERE, 10.00,
					vecp(-50.0, 16.5, 80.0),
					vecp(12.0, 12.0, 12.0),
					vecp(0.75, 0.55, 0.15),
					DIFF); // obj diff
	rtv1->scene.obj[3] = obj(SPHERE, 10.00,
					vecp(150.0, 16.5, 20.0),
					vecp(12.0, 12.0, 12.0),
					vecp(0.75, 0.25, 0.25),
					DIFF); // obj diff
	rtv1->scene.obj[4] = obj(PLAN, 0.0,
					vecp(0.0, 0.0, 40.0),
					vecp(0.0, 0.0, 0.0),
					vecp(0.40, 0.75, 0.75),
					DIFF); // plan
	rtv1->scene.obj[5] = obj(SPHERE, 10.00,
					vecp(-50.0, 16.5, 20.0),
					vecp(12.0, 12.0, 12.0),
					vecp(0.75, 0.25, 0.25),
					DIFF); // obj diff
	rtv1->scene.obj[6] = obj(SPHERE, 20.0,

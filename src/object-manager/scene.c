...
void 	init_scene(char **av, t_rtv1 *rtv1)
{
	...
	rtv1->scene.obj[5] = obj(SPHERE, 1e5,
					...
					vecp(0.75, 0.75, 0.75),
					DIFF); //Top
	rtv1->scene.obj[6] = obj(SPHERE, 16.5,
					vecp(27.0, 16.5, 47.0),
					vecp(0.0, 0.0, 0.0),
	...
	rtv1->scene.obj[8] = obj(SPHERE, 16.5,
					...
					vecp(0.25, 0.25, 0.75),
					DIFF); // Mirror red
	rtv1->scene.obj[9] = obj(SPHERE, 5.00,
					vecp(80.0, 16.5, 20.0),
					vecp(12.0, 12.0, 12.0),
					vecp(0.75, 0.75, 0.25),
					DIFF); // obj diff
	rtv1->scene.obj[10] = obj(SPHERE, 10.00,
					vecp(130.0, 16.5, 80.0),
					vecp(12.0, 12.0, 12.0),
					vecp(0.75, 0.55, 0.15),
					DIFF); // obj diff
	rtv1->scene.obj[11] = obj(SPHERE, 10.00,
					vecp(-50.0, 16.5, 80.0),
					vecp(12.0, 12.0, 12.0),
					vecp(0.75, 0.55, 0.15),
					DIFF); // obj diff
	rtv1->scene.obj[12] = obj(SPHERE, 10.00,
	...
	rtv1->scene.obj[14] = obj(SPHERE, 10.00,
					...
					vecp(0.75, 0.25, 0.25),
					DIFF); // obj diff
	rtv1->scene.obj[15] = obj(SPHERE, 20.0,
